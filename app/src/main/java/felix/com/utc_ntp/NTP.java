...
public abstract class NTP {
    ...
    private RESULT taskNTP(String host) {
        ...
        try {
            ...
            ipv4Addr = InetAddress.getByName(host);    //設定NTP伺服器
            socket = new DatagramSocket();
            socket.setSoTimeout(timeout);

            // Send NTP request
            byte[] data = new PACKAGE().toByteArray();
            ...
            pkg = new PACKAGE(incoming.getData());


        } catch (NoRouteToHostException e) {
            e.printStackTrace();
            System.out.println("No route to host exception for address: " + ipv4Addr);
        } catch (ConnectException e) {    // Connection refused. Continue to retry.
            e.fillInStackTrace();
        ...
        return new RESULT(host, pkg, sentTime, recvTime);
    ...
    public final static class PACKAGE {
        ...
        /** */
        /**
         * Constructs a new PACKAGE from an array of bytes.
         */
        public PACKAGE(byte[] array) {
         ...
         */
        public PACKAGE(byte leapIndicator, byte version, byte mode, short stratum, byte pollInterval, byte precision, double rootDelay, double rootDispersion, byte[] referenceIdentifier, double referenceTimestamp, double originateTimestamp, double receiveTimestamp, double transmitTimestamp) {
        ...
        /** */
        /**
         * Constructs a new PACKAGE in client -> server mode, and sets the
        ...
        /** */
        /**
         * Returns a string representation of a PACKAGE
         */
